...
<br>
            ...
            ?>
            <input type = "button" class="codeButton" value="Type Modify" OnClick="window.location='displayCode.php?fileName=<?php echo end($fileName);?>'">
    ...
    case "DELETE":
        ...
        ?>
        <div class="container">
            <h2>Confirm deletion of the following property Type</h2>
